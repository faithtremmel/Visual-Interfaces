class AQIDaysChart{
    constructor(_config, _data) {
        ...
        this.data = _data[0].aqi_percents; 
    ...
    initVis() {
        ...
        vis.colorScale = d3.scaleOrdinal()
            ...
            .domain(['Good','Moderate','Unhealthy for sensitive group','Unhealthy','Very unhealthy','Hazardous']);
    ...
    renderVis() {
        ...
        vis.chart.selectAll(".aqi-bar")
            .data(vis.data)
            .join("rect")
            .attr("class", "aqi-bar bar")
